...
ActiveRecord::Schema.define(version: 20150331173318) do
  ...
  add_index "container_types", ["container_id"], name: "index_container_types_on_container_id", using: :btree
  ...
  add_index "containers", ["container_type_id"], name: "index_containers_on_container_type_id", using: :btree
